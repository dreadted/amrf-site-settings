...
theme — the same "hide this for non-admins", "block
XML-RPC", "add a GDPR export handler" code, copy-pasted each time. This plugin collects that logic in one place, generalized so it works across sites rather than one specific theme.

## Features

This plugin adds a new admin panel menu named "Site Settings" with admin pages for the following features:
...
- **Business & Contact / Address / Social Media**
